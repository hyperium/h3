...
mod tests {
    ...
    use super::*;
    use crate::qpack2::prefix_string::huffman_decode::StatefulHuffmanDecoder;
    ...
    macro_rules! encoding {
        [ $( $code:expr => $( $byte:expr ),* ; )* ] => { $( {
            ...
            assert_eq!(res, bytes, "fail to encode {}", $code);
        } )* }
    }
    ...
    fn round_trip_exact_when_bit_len_multiple_of_8() {
        ...
        let reencoded = decoded.hpack_encode();
